        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" role="form" action="http://localhost:8085/ProjetoWEB/controladorpagamento" method="post">
              ...
              <div class="form-group">
                <div class="col-sm-3">
                  <label for="inputCURSO" class="control-label">Informar o CHASSI a ser EXCLUÍDO:</label>
                </div>
                <div class="col-sm-9">
                  <input type="number" name="chassi" class="form-control" id="inputCURSO" placeholder="CHASSI" required>
                </div>
              </div>
