        ...
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" role="form" action="http://localhost:8085/ProjetoWEB/controladorpagamento" method="post">
              ...
              <div class="form-group">
                <div class="col-sm-3">
                  <label for="inputCURSO" class="control-label">Informar o CHASSI:</label>
                </div>
                <div class="col-sm-9">
              ...
              <div class="form-group">
                <div class="col-sm-3">
                  <label for="inputDATA" class="control-label">Informar a NOVA DATA DA SAIDA :</label>
                </div>
                <div class="col-sm-9">
                  <input type="date" name="datainscricao" class="form-control" id="inputDATA" title="Preencha a Saida" required>
                </div>
              </div>
