   ...
   <title>Pagina de Sucesso !</title>
        ...
        <div class="row text-center">
          <div class="col-md-12 text-center">
            <h1 class="text-center">${mensagem}</h1>
            	...
            	<h3 class="text-center">Chassi:${veiculo.chassi}</h3>
            	<h3 class="text-center">Modelo:${veiculo.modelo}</h3>
            	<h3 class="text-center">Valor:${veiculo.valor}</h3>
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
           <a class="btn btn-default" href="index.jsp">Retornar ao Menu Veiculo</a>
          </div>
        </div>
      </div>
    </div> 
