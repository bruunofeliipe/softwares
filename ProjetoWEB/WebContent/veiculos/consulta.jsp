...
<html><head>
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h3 class="tt_menu">&gt;&gt; VEICULOS - CONSULTAR UM VEICULO &lt;&lt;</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" role="form" action="http://localhost:8085/ProjetoWEB/controladorveiculo" method="post">
              <div class="form-group">
                <div class="col-sm-2">
                  <label for="inputEmail3" class="control-label">Informar o CHASSI:</label>
                </div>
                <div class="col-sm-10">
                  <input type="number" name="chassi" class="form-control" id="inputEmail3" placeholder="CHASSI" required>
                </div>
              </div>
